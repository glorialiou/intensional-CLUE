...
--make seed random
genCorrectProf = case (randomNumbers 1) of
       [1] -> Bruce
       [2] -> Chen
       [3] -> Greenberg
       [4] -> Kauchak
...
genCorrectClass = case (randomNumbers 1) of
       [1] -> CS52
       [2] -> CS62
       [3] -> CS81
       [4] -> Systems
...
genCorrectLocation = case (randomNumbers 1) of
       [1] -> Beanbag
       [2] -> Hall
       [3] -> Office
       [4] -> Lab
...
genCorrectWorld = World {p = genCorrectProf, c = genCorrectClass, l = genCorrectLocation}
